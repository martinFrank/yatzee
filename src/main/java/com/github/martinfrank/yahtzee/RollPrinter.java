...
public class RollPrinter {
    ...
    public static void print(PrintStream out, YahtzeeGame yahtzeeGame) {
        if (yahtzeeGame.hasRowsLeft()) {
            out.println(SEP);
            out.println("|  dice #   | 1 | 2 | 3 | 4 | 5 |");
            out.println(SEP);
            out.println(getDiceLine(1, yahtzeeGame.getRoll()));
            out.println(SEP);
            out.println(getKeepLine(1, yahtzeeGame.getRoll()));
            out.println(SEP);
            out.println(getDiceLine(2, yahtzeeGame.getRoll()));
            out.println(SEP);
            out.println(getKeepLine(2, yahtzeeGame.getRoll()));
            out.println(SEP);
            out.println(getDiceLine(3, yahtzeeGame.getRoll()));
            out.println(SEP);
        }
    }
